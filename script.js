...
// =================================================
function removing2(){
    setTimeout('floor_G.classList.remove("on-floor")', 700);
    setTimeout('floor1.classList.add("on-floor")', 1400);
    setTimeout('floor1.classList.remove("on-floor")', 2100);
    setTimeout('floor2.classList.add("on-floor")', 2800);
}
function removeing3() {
    setTimeout('floor_G.classList.remove("on-floor")', 1000);
    setTimeout('floor1.classList.add("on-floor")', 2000);
    setTimeout('floor1.classList.remove("on-floor")', 3000);
    setTimeout('floor2.classList.add("on-floor")', 4000);
    setTimeout('floor2.classList.remove("on-floor")', 5000);
    setTimeout('floor3.classList.add("on-floor")', 6000);
}
function removing4(){
    setTimeout('floor_G.classList.remove("on-floor")', 1000);
    setTimeout('floor1.classList.add("on-floor")', 2000);
    ...
    setTimeout('floor4.classList.add("on-floor")', 8000);
...
function removing5(){
    ...
    setTimeout('floor3.classList.remove("on-floor")', 7000);
    setTimeout('floor4.classList.add("on-floor")', 8000);
    setTimeout('floor4.classList.remove("on-floor")', 9000);
    setTimeout('floor5.classList.add("on-floor")', 10000);
...
function removing6(){
    ...
    setTimeout('floor6.classList.add("on-floor")', 12000);
...
function removing7(){
    ...
    setTimeout('floor5.classList.remove("on-floor")', 11000);
    setTimeout('floor6.classList.add("on-floor")', 12000);
    setTimeout('floor6.classList.remove("on-floor")', 13000);
    setTimeout('floor7.classList.add("on-floor")', 14000);
...
function removing8(){
    ...
    setTimeout('floor8.classList.add("on-floor")', 16000);
...
function removing9(){
    ...
    setTimeout('floor7.classList.remove("on-floor")', 15000);
    setTimeout('floor8.classList.add("on-floor")', 16000);
    setTimeout('floor8.classList.remove("on-floor")', 17000);
    setTimeout('floor9.classList.add("on-floor")', 18000);
...
function removing10(){
    ...
    setTimeout('floor8.classList.remove("on-floor")', 17000);
    setTimeout('floor9.classList.add("on-floor")', 18000);
    setTimeout('floor9.classList.remove("on-floor")', 19000);
    setTimeout('floor10.classList.add("on-floor")', 20000);
